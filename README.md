...
- readFile不再trim避免破坏有些设置项目 可能导致某些模块加载配置错误 💣
- 抽取模块工具类
- 控制台支持重载nickname
...
抛弃语义化版本使用类Chrome式版本声明 **功能版本号.修复号.提交/构建号-附加名词**

比如 8.3.1

- 功能号 表示功能设计版本等级，大型功能升级/导致模块不兼容的更新
- 修复号 表示特定内容的修复，比如Mirai升级/BUG修复 务必更新
- 提交号 表示做了代码级变动，细节美化/代码整理/优化代码 推荐更新
